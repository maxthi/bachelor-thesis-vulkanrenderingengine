...
#include "../descriptor_set_layouts/dsl_texture.hpp"

namespace vre
{
	/// @brief Class to create uniform buffer objects that provide access to the drawables attached render target
	/// and to the mvp matrix.
	class UniformBufferRenderTarget : public UniformBuffer
	{
	public:
